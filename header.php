<?php
 ...
 $nomre =$_SESSION['nombreUsuario_S'];
?>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block"><?php echo  $nomre  ?></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li>
                        <a class="dropdown-link-item" data-toggle="modal" type="button"  onclick="cambiarclave(<?php echo  $idUsuario ?>);">
                      ...
                      <li class="dropdown-footer">
                        <a class="dropdown-link-item  nav-text" href="salir.php"> <i class="mdi mdi-logout">cerrar sesion</i>  </a>
                      </li>
                    </ul>
                  </li>
                </ul>
