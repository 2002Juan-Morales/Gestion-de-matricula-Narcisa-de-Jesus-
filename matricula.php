...
<div class="card card-default">
  <div class="px-6 py-4">
  <h2><i class="mdi mdi-folder-account"></i> Gestion matricula</h2>
  </div>
</div>
...
<div class="card card-default">
  ...
  <a  class="btn btn-success btn-pill"  href="nueva_matricula.php" ><i class="mdi mdi-account"></i>  Agregar Matricula </a>
...
$(document).ready(function(){
    listar('ajax/listar_matricula.php');
    //prueba();
});
function listar(url){
    $.ajax({
