...
<div class="card card-default">
  <div class="px-6 py-4">
  <h2><i class=" mdi mdi-account-group"></i> Gestion Estudiante</h2>
  </div>
</div>
...
<div class="card card-default">
  <div class="card-header">
    ...
    <button type='button' class="btn btn-success btn-pill" data-toggle="modal" onclick="NuevoEstudiante();" ><i class="mdi mdi-account"></i>  Agregar Estudiante </button>
