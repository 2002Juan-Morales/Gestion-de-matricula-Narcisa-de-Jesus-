...
<div class="card card-default">
  <div class="px-6 py-4">
  <h2> <i class="mdi mdi-account-multiple"></i> Gestion Usuario</h2>
  </div>
</div>
...
<div class="card card-default">
  <div class="card-header">
    ...
    <button type='button' class="btn btn-success btn-pill" data-toggle="modal" onclick="NuevoUsuario();" ><i class="mdi mdi-account"></i>  Agregar Usuario </button>
